	...
	public ListaSolicitudEmpre() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			}
			{
				...
				button.setIcon(new ImageIcon(ListaSolicitudEmpre.class.getResource("/img/buscar.png")));
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnEliminar.setIcon(new ImageIcon(ListaSolicitudEmpre.class.getResource("/img/borrar.png")));
				btnEliminar.setEnabled(false);
				...
				});
				{
					...
					btnDetallar.setIcon(new ImageIcon(ListaSolicitudEmpre.class.getResource("/img/ver.png")));
					btnDetallar.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							InfoSoli detail = new InfoSoli(BolsaLaboral.getInstance().RetornarSolocitudCod(codigo));
			...
			}
			{
				...
				btnModificar.setIcon(new ImageIcon(ListaSolicitudEmpre.class.getResource("/img/modificar.png")));
			...
			}
			{
				...
				cancelButton.setIcon(new ImageIcon(ListaSolicitudEmpre.class.getResource("/img/cancelar.png")));
