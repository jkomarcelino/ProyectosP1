...
//	private JDateChooser FechaNacimiento; QUE PONGA LA EDAD
	 ...
	 * 
	 * public static void main(String[] args) { try { RegSolicitud dialog
	 * = new RegSolicitud();
	 ...
	 * /** Create the dialog.
	 */
	public RegSolicitud(String title, boolean modificar, Personal person, Personal persona) {
		...
		panel_Universitario.add(separator_2);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				if (!modificar) {
					btnRegistrar.setIcon(new ImageIcon(RegSolicitud.class.getResource("/img/add.png")));
				} else {
					btnRegistrar.setIcon(new ImageIcon(RegSolicitud.class.getResource("/img/modificar.png")));
				}
			...
			//								fechaNacimiento, nacionalidad, sexo, estadoCivil, direccion, provincia,
				...
				});
				{
					...
					btnMover.setIcon(new ImageIcon(RegSolicitud.class.getResource("/img/Siguiente.png")));
					btnMover.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if (panel2.isVisible()) {
								btnMover.setIcon(
										new ImageIcon(RegSolicitud.class.getResource("/img/Siguiente.png")));
							} else {
								btnMover.setIcon(
										new ImageIcon(RegSolicitud.class.getResource("/img/retroceso.png")));
							}
			...
			}
			{
				...
				cancelButton.setIcon(new ImageIcon(RegSolicitud.class.getResource("/img/cancelar.png")));
	...
	public void call() {
		dispose();
		RegSolicitud soli = new RegSolicitud("Insertar Personal", false, null, null);
		soli.setModal(true);
